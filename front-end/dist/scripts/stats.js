...
const createStatsItems = () => {
    for (const [key, value] of Object.entries(urls)) {
        ...
        const newUrlItem = createAnchorElement(shortUrlLink, "new-url-item", undefined, shortUrlLink);
        statsItem.append(newUrlItem);
        const clickItems = createElement("div", "click-items", undefined, undefined);
        const oldUrlItem = createAnchorElement(oldUrlLink, "old-url-item", undefined, oldUrlLinkText);
